...
#     `Line` to allow for skipping of errornous constructs.
...
o = (patternString, action, options) ->
  ...
  if /yy\.|addBody|addElse/.test action
      rulesize = (patternString.split ' ').length
      # Set first and last line of produced node to either current line or
      # according to line numbers of child nodes.
      action = """
        (function() {
          var node = #{action};
          if (node instanceof yy.Base) {
            ...
            for (i=stacksize-#{rulesize}; i<stacksize; i++) {
